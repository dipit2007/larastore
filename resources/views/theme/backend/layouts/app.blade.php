...
<head>
    ...
    <!-- Bootstrap Core Css -->
    <link href="{{ asset('theme/backend/AdminBSBMaterialDesign/plugins/bootstrap/css/bootstrap.css') }}" rel="stylesheet">

    <!-- Waves Effect Css -->
    <link href="{{ asset('theme/backend/AdminBSBMaterialDesign/plugins/node-waves/waves.css') }}" rel="stylesheet" />
...
<body class="theme-teal">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">LARAVEL MULTI SHOP</a>
            </div>
    ...
    <!-- Bootstrap Core Js -->
    <script src="{{ asset('theme/backend/AdminBSBMaterialDesign/plugins/bootstrap/js/bootstrap.js') }}"></script>

    <!-- Select Plugin Js -->
    <script src="{{ asset('theme/backend/AdminBSBMaterialDesign/plugins/bootstrap-select/js/bootstrap-select.js') }}"></script>

    <!-- Slimscroll Plugin Js -->
    <script src="{{ asset('theme/backend/AdminBSBMaterialDesign/plugins/jquery-slimscroll/jquery.slimscroll.js') }}"></script>
