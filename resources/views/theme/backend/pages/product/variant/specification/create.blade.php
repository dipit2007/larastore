            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="{{ route('admin.product.variant.specification.index') }}">Product Variant Specification List</a></li>
                                        @if(0)
                        ...
                        <div class="body">                            
                            {!! Form::open(array('route' => array('admin.product.variant.specification.store') , 'role' => "form", 'files'=>true )) !!}
  
                                <div class="col-md-12">
                                    <p>
                                        <b>Product</b>
                                    </p>
                                    {!! Form::select('product', $productList, $selectedProduct, ['class' => 'form-control show-tick', 'data-live-search' => "true"]) !!}
                                ...
                                <label for="product_variant_specification_title">Title</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="title" id="product_variant_specification_title" class="form-control" placeholder="Enter product Variant Specification Title">
                                    </div>
                                </div>

                                <label for="product_variant_specification_description">Desciption</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="description" id="product_variant_specification_description" class="form-control" placeholder="Enter product Variant Specification description">
                                    </div>
                                </div>
