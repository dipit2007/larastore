@extends('theme.backend.layouts.app')
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="{{ route('admin.product.variant.image.create') }}">Add Product Variant Image</a></li>
                                        @if(0)
    ...
    <script>
        ...
        var dt = $('#dataTableId1').DataTable( {
            ...
            "processing": true,
            "serverSide": true,                    
            "ajax": "{{ route('admin.product.variant.image.datatable') }}",
            "columns": [
            ...
            { data: 'description', name: 'description' },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return '<div class="product-image" style="width:200px;height:200px;"><img style="width:200px;height:200px;" src="/storage/'+ row['filepath'] + '"/></div>';
